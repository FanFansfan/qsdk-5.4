...
#define LBD_FREQ_INVALID 0xFFFF
...
typedef struct lbd_bssInfo_t {
    ...
    /// The frequency on which the BSS is operating
    u_int16_t freq;
} lbd_bssInfo_t;
...
/// Value used to signal the capacity value should not be modified.
#define LBD_UNKNOWN_LINK_CAP 0xFFFF
