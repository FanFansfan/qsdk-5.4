...
/**
 * @brief Clear RRM/WNM Filter Flags in Driver From LBD
 *
 * @param [in] Bsteer Control Handle
 *
 * @return LBD_OK on successfully Clear; otherwise LBD_NOK
 */
LBD_STATUS wlanifControlClearRRMWNMFilter(wlanifBSteerControlHandle_t handle);
 ...
 * @param [in] vapReadyStatus the flag to indicate VAP readiness across each band
 *
 * @return LBD_OK on successfully enable/disable; otherwise LBD_NOK
 */
LBD_STATUS wlanifBSteerControlDisable(wlanifBSteerControlHandle_t handle, LBD_BOOL vapReadyStatus);
 ...
 * @param [in] freq       the  on which to set overload status
...
/**
* @brief Find whether the radio can be resolved from the system index from the driver.
*
* @param [in] state    the handle returned from wlanifBSteerControlCreate() used to
*                      resolve radio name
*
* @param [in] radioName    the name of the radio interface
*
* @return  LBD_OK if the radio is resolved successfully; otherwise LBD_NOK
*/
 ...
 * @param [in] freqList set of frequency to enable or disable
 * @param [in] staAddr the MAC address of the STA
 ...
 * @param [out] freqList     set of active frequency
 ...
 * @return  LBD_OK if the request is sent successfully; otherwise LBD_NOK
 */
LBD_STATUS wlanifBSteerControlRequestDownlinkRSSI(wlanifBSteerControlHandle_t handle,
                                                  const lbd_bssInfo_t *bss,
                                                  const struct ether_addr *staAddr,
 ...
 * @return LBD_OK on success; otherwise LBD_NOK
 */
LBD_STATUS wlanifBSteerControlCmnSendBcnRequestExtended(wlanifBSteerControlHandle_t handle,
                                                        const struct ether_addr *staAddr,
...
#define WLANIFBSTEERCONTROL_MAP_ZERO_BSS_ENABLE "EnableZeroBss"
