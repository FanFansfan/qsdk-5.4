...
typedef enum bandmon_event_e {
    ...
    bandmon_event_num_active_channels_change,  ///< Number of active channels change
...
typedef struct bandmon_numActiveChannelsChangeEvent_t {
    /// Total number of active channels (local and remote)
    u_int8_t numActiveChannels;
} bandmon_numActiveChannelsChangeEvent_t;
...
#define BANDMON_MU_OVERLOAD_THRESHOLD_W6_KEY "MUOverloadThreshold_W6"
...
#define BANDMON_MU_SAFETY_THRESHOLD_W6_KEY   "MUSafetyThreshold_W6"
