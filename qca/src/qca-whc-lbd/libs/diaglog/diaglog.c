...
#undef QCA_MOD_INPUT
#define QCA_MOD_INPUT QCA_MOD_LBD_DIAGLOG
...
struct profileElement diaglogElementDefaultTable[ ] = {
        ...
        { DIAGLOG_LOG_LEVEL_MULTI_AP_KEY,  "2" },
        { NULL, NULL },
};
...
static void diaglogReadConfigLevel(enum mdModuleID_e moduleId) {
    ...
    switch (moduleId) {
        ...
        case mdModuleID_MapService:
            key = DIAGLOG_LOG_LEVEL_MULTI_AP_KEY;
            break;
...
static const struct {
    ...
    { "MultiAPLevel", mdModuleID_MapService },
};
