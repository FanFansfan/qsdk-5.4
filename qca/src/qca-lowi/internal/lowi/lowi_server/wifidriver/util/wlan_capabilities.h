...
#define TARGET_TYPE_PRONTO      0xA0 // PRONTO with 2-sided RTT support
#define TARGET_TYPE_HELIUM      19   // Helium
#define TARGET_TYPE_HASTING     23   // HASTING
/**
