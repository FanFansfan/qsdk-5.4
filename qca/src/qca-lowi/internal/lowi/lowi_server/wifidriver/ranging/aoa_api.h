/*
 * This header file has prototypes and definitions for the AoA measurement library.
 * The file is a copy of an existing file located under a wigig directory. It exists
 * here so that compiling lowi is never a problem because the path to the original
 * file cannot be found. The functions will be implemented in a shared library that
 * LOWI will use if the library exists and can be opened successfully. The name of the
 * files remains unchanged to ease maintenance.
 *
