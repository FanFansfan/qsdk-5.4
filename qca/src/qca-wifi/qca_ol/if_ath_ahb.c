...
static const struct platform_device_id ath9k_platform_id_table[] = {
	...
	{
		.name = "qcn6122_wmac", /* Update the name with proper device name */
		.driver_data = QCN6122_DEVICE_ID,
	},
    {},
};
...
const struct of_device_id cnss_ahb_wifi_of_match[] = {
    ...
    {.compatible = "qcom,cnss-qca5018", .data = (void *) &ath9k_platform_id_table[4] },
    {.compatible = "qcom,cnss-qcn6122", .data = (void *) &ath9k_platform_id_table[5] },
    { /*sentinel*/},
};
#endif
