...
uint32_t target_if_sa_api_get_sa_supported(struct wlan_objmgr_psoc *psoc)
{
	...
	if (!rx_ops) {
		sa_api_err("rx_ops is NULL");
		return 0;
	}

	return rx_ops->sa_api_rx_ops.sa_api_get_sa_supported(psoc);
}
...
uint32_t target_if_sa_api_get_validate_sw(struct wlan_objmgr_psoc *psoc)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_get_validate_sw(psoc);
}
					...
					uint8_t value)
{
	...
	rx_ops->sa_api_rx_ops.sa_api_enable_sa(psoc, value);
}
...
uint32_t target_if_sa_api_get_sa_enable(struct wlan_objmgr_psoc *psoc)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_get_sa_enable(psoc);
}
					 ...
					 char *value)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_ucfg_set_param(pdev, value);
}
					 ...
					 char *value)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_ucfg_get_param(pdev, value);
}
				 ...
				 struct wlan_objmgr_pdev *pdev)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_is_tx_feedback_enabled(pdev);
}
				 ...
				 struct wlan_objmgr_pdev *pdev)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_is_rx_feedback_enabled(pdev);
}
		...
		struct wlan_objmgr_pdev *pdev, struct wlan_objmgr_peer *peer, struct sa_tx_feedback *feedback)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_update_tx_feedback(pdev, peer, feedback);
}
		...
		struct wlan_objmgr_pdev *pdev, struct wlan_objmgr_peer *peer, struct sa_rx_feedback *feedback)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_update_rx_feedback(pdev, peer, feedback);
}
						...
						struct sa_rate_cap *rate_cap)
{
	...
	rx_ops->sa_api_rx_ops.sa_api_peer_assoc_hanldler(pdev, peer, rate_cap);
}
					...
					uint32_t rate)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_convert_rate_2g(rate);
}
					...
					uint32_t rate)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_convert_rate_5g(rate);
}
					...
					struct wlan_objmgr_pdev *pdev)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_get_sa_mode(pdev);
}
					...
					struct wlan_objmgr_pdev *pdev)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_get_beacon_txantenna(pdev);
}
					...
					struct wlan_objmgr_pdev *pdev)
{
	...
	return rx_ops->sa_api_rx_ops.sa_api_cwm_action(pdev);
}
