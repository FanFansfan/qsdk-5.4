...
QDF_STATUS
ol_tx_print_tso_stats(struct cdp_soc_t *soc, uint8_t vdev_id)
{
    ol_txrx_vdev_handle vdev;
    struct ol_txrx_stats *stats;
    struct cdp_pdev_stats_cnvrged *pdev_stats;
    ...
    stats = &pdev->stats.pub;
    pdev_stats = &pdev->pdev_stats;
