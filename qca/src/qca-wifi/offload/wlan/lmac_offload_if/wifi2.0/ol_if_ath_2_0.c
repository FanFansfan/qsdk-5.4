...
qdf_export_symbol(ol_ath_enable_smart_log);
/*
...
qdf_export_symbol(send_fatal_cmd);
...
qdf_export_symbol(ol_smart_log_connection_fail_start);
...
qdf_export_symbol(ol_smart_log_connection_fail_stop);
...
qdf_export_symbol(ol_smart_log_fw_pktlog_enable);
...
qdf_export_symbol(ol_smart_log_fw_pktlog_disable);
...
qdf_export_symbol(ol_smart_log_fw_pktlog_start);
...
qdf_export_symbol(ol_smart_log_fw_pktlog_stop);
...
qdf_export_symbol(ol_smart_log_fw_pktlog_stop_and_block);
...
qdf_export_symbol(ol_smart_log_fw_pktlog_unblock);
#endif /* REMOVE_PKT_LOG */
