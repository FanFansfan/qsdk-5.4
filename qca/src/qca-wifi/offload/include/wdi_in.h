...
typedef qdf_nbuf_t (*ol_txrx_tx_fp)(
    struct cdp_soc_t *soc, uint8_t vdev_id, qdf_nbuf_t msdu_list);
...
#define wdi_in_debug(soc, vdev_id, debug_specs) 0
#define wdi_in_fw_stats_cfg(soc, vdev_id, type, val) 0
#define wdi_in_fw_stats_get(soc, vdev_id, req) 0
#define wdi_in_aggr_cfg(soc, vdev_id, max_subfrms_ampdu, max_subfrms_amsdu) 0

#else /*---------------------------------------------------------------------*/

int wdi_in_debug(struct cdp_soc_t *soc, uint8_t vdev_id,
                 int debug_specs);
...
int wdi_in_aggr_cfg(struct cdp_soc_t *soc, uint8_t vdev_id,
