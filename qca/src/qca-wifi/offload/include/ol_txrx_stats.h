 ...
 * @msdu_cnt_err: Number of t2h msgs for which msdu_cnt is invalid
 * @mpdu_cnt_err: Count of t2h msgs for which num_mpdu_range is invalid
 */
struct ol_txrx_data_stats {
	struct {
		struct {
	...
	uint32_t msdu_cnt_err;
	uint32_t mpdu_cnt_err;
