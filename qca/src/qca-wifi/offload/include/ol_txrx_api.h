...
int
ol_tx_ll_pflow_ctrl(ol_txrx_vdev_handle vdev, qdf_nbuf_t netbuf, u_int8_t tid);
...
#define OL_TX_LL_FORWARD_PACKET(_vdev, _msdu, _num_msdus, _tid) ol_tx_ll_pflow_ctrl(_vdev, _msdu, _tid)

#define OL_TX_LL_WRAPPER(_vdev, _msdu, _oshandle, _tid) ol_tx_ll_pflow_ctrl(_vdev, _msdu, _tid);
#else
int
