...
void
htt_tx_mgmt_desc_free(struct htt_pdev_t *pdev, A_UINT32 desc_id, A_UINT32 status)
{
...
qdf_export_symbol(htt_tx_mgmt_desc_free);
...
qdf_export_symbol(htt_tx_mgmt_desc_drain);
...
qdf_export_symbol(htt_tx_mgmt_desc_mark_delayed_free);
