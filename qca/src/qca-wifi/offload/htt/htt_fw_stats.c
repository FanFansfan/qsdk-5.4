...
{
    qdf_info("\n ### HALPHY STATS ###\n");
    qdf_info("                           CALIBRATION STATS                                          ");
    qdf_info("************************************************************************************************************************************");
    qdf_info("cal     home/scan   cal_reg_enable   hw_cal_status   post_process   hw_enabled   CalFailStatus   CalFailCount   lastCalTime(target)");
    qdf_info("************************************************************************************************************************************");
    qdf_info("NF         %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->nf_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->nf_stats.calFailCnt),
                hal_stats->nf_stats.lastCaltime);
    qdf_info("IBF        %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->ibf_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->ibf_stats.calFailCnt),
                hal_stats->ibf_stats.lastCaltime);
    qdf_info("DPD        %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->dpd_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->dpd_stats.calFailCnt),
                hal_stats->dpd_stats.lastCaltime);
    qdf_info("RXDCO      %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->RxDCO_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->RxDCO_stats.calFailCnt),
                hal_stats->RxDCO_stats.lastCaltime);
    qdf_info("PkDetect   %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->PeakDetect_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->PeakDetect_stats.calFailCnt),
                hal_stats->PeakDetect_stats.lastCaltime);
    qdf_info("TxIQCal    %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->TxIQCal_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->TxIQCal_stats.calFailCnt),
                hal_stats->TxIQCal_stats.lastCaltime);
    qdf_info("RxIQCal    %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->RxIQCal_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->RxIQCal_stats.calFailCnt),
                hal_stats->RxIQCal_stats.lastCaltime);
    qdf_info("crrLkg     %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->carrierLkg_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->carrierLkg_stats.calFailCnt),
                hal_stats->carrierLkg_stats.lastCaltime);
    qdf_info("RxFltrCal  %u             %u               %u             %u             %u             %s             %u             %u",
		...
		((WLAN_HALPHY_DBG_STATS_IS_CAL_FAIL_CNT_VALID_GET(hal_stats->RxFltrCal_stats.Statusflags) == 1) ?
		"Valid" : "Invalid"),
		WLAN_HALPHY_DBG_STATS_CAL_FAIL_CNT_GET(hal_stats->RxFltrCal_stats.calFailCnt),
                hal_stats->RxFltrCal_stats.lastCaltime);
    qdf_info("************************************************************************************************************************************");

    qdf_info("\n########  HALPHY TX STATS  ########");
    qdf_info(" dpd_hw_queued          :    %u", hal_stats->tx_stats.dpd_hw_queued);
    qdf_info(" dpd_hw_reaped          :    %u", hal_stats->tx_stats.dpd_hw_reaped);
    qdf_info(" dpd_tx_done            :    %u", hal_stats->tx_stats.dpd_tx_done);
    qdf_info(" dpd_tx_abort           :    %u", hal_stats->tx_stats.dpd_tx_abort);
    qdf_info(" dpd_tx_fail            :    %u", hal_stats->tx_stats.dpd_tx_fail);
    qdf_info(" ibf_hw_queued          :    %u", hal_stats->tx_stats.ibf_hw_queued);
    qdf_info(" ibf_hw_reaped          :    %u", hal_stats->tx_stats.ibf_hw_reaped);
    qdf_info(" ibf_tx_done            :    %u", hal_stats->tx_stats.ibf_tx_done);
    qdf_info(" ibf_tx_abort           :    %u", hal_stats->tx_stats.ibf_tx_abort);
    qdf_info(" ibf_tx_fail            :    %u", hal_stats->tx_stats.ibf_tx_fail);
    qdf_info(" tx_async_enqueue       :    %u", hal_stats->tx_stats.tx_async_enqueue);
    qdf_info(" tx_async_dequeue       :    %u", hal_stats->tx_stats.tx_async_dequeue);

    qdf_info("\n########      ANI STATS    ########");
    qdf_info(" ofdm_ANI_level         :    0x%x",hal_stats->ani_stats.ofdm_ANI_level);
    qdf_info(" cck_ANI_level          :    0x%x",hal_stats->ani_stats.cck_ANI_level);
    qdf_info(" th_d0_b                :    0x%x",hal_stats->ani_stats.th_d0_b);
    qdf_info(" th_d0_b_tf_est         :    0x%x",hal_stats->ani_stats.th_d0_b_tf_est);
    qdf_info(" firstep                :    0x%x",hal_stats->ani_stats.firstep);
    qdf_info(" firstep_low            :    0x%x",hal_stats->ani_stats.firstep_low);
    qdf_info(" rssi_thr1a             :    0x%x",hal_stats->ani_stats.rssi_thr1a);
    qdf_info(" cycpwr_thr1            :    0x%x",hal_stats->ani_stats.cycpwr_thr1);
    qdf_info(" relpwr                 :    0x%x",hal_stats->ani_stats.relpwr);
    qdf_info(" bk_in_backoff          :    0x%x",hal_stats->ani_stats.bk_in_backoff);
    qdf_info(" enable_rfsat_strong    :    0x%x",hal_stats->ani_stats.enable_rfsat_strong);
    qdf_info(" enable_srch_start_gain :    0x%x",hal_stats->ani_stats.enable_srch_start_gain);
    qdf_info(" use_self_corr_low      :    0x%x",hal_stats->ani_stats.use_self_corr_low);
}
