...
#else
#define A_LOGGER(mask, mod, args...)    qdf_nofl_info(KERN_ALERT args)
#define A_PRINTF(args...)               qdf_nofl_info(KERN_ALERT args)
#endif /* ANDROID */
#define A_PRINTF_LOG(args...)           qdf_nofl_info(args)
...
#define A_ASSERT(expr)  \
    if (!(expr)) {   \
        qdf_nofl_info(KERN_ALERT"Debug Assert Caught, File %s, Line: %d, Test:%s \n",__FILE__, __LINE__,#expr); \
