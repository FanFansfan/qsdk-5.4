...
#if QCA_SUPPORT_SON
extern int son_ioctl_ald_getStatistics(struct net_device *dev, void *info, void *w, char *extra);
#endif
   ...
   */
    ...
    */
    { ATH_IOCTL_GPIO_CONFIG,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 7, 0, "gpio_config" },
    ...
    { OL_ATH_PARAM_ACS_SNRVAR |OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,        "acs_rssivar" },
    { OL_ATH_PARAM_ACS_SNRVAR |OL_ATH_PARAM_SHIFT,  0,
...
#endif
     { OL_ATH_PARAM_OBSS_SNR_THRESHOLD |OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "obss_rssi_th" },
     { OL_ATH_PARAM_OBSS_SNR_THRESHOLD |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "gobss_rssi_th" },
     { OL_ATH_PARAM_OBSS_RX_SNR_THRESHOLD |OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "obss_rxrssi_th" },
     { OL_ATH_PARAM_OBSS_RX_SNR_THRESHOLD |OL_ATH_PARAM_SHIFT, 0,
    ...
    { OL_ATH_PARAM_MGMT_SNR_THRESHOLD | OL_ATH_PARAM_SHIFT,
...
/*  pdev stats timer */
    ...
    { OL_ATH_PARAM_NO_BACKHAUL_RADIO | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "nobckhlradio" },
    { OL_ATH_PARAM_NO_BACKHAUL_RADIO | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_nobckhlradio" },
#ifdef QCA_CBT_INSTRUMENTATION
    { OL_ATH_PARAM_FUNC_CALL_MAP | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "get_call_map" },
#endif /* QCA_CBT_INSTRUMENTATION */
    { OL_ATH_PARAM_RNR_STATS | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_rnr_stats" },
    { OL_ATH_PARAM_MBSS_AUTOMODE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "mbss_auto" },
    { OL_ATH_PARAM_MBSS_AUTOMODE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_mbss_auto" },
    { OL_ATH_PARAM_NSS_WIFI_OFFLOAD_STATUS | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_nss_wifi_ol" },
    { OL_ATH_PARAM_ENABLE_EMA | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "enable_ema" },
#if !(defined REMOVE_PKT_LOG) && (defined PKTLOG_DUMP_UPLOAD_SSR)
    { OL_ATH_PARAM_PKTLOG_DUMP_UPLOAD_SSR | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "upload_pktlog" },
    { OL_ATH_PARAM_PKTLOG_DUMP_UPLOAD_SSR | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_upload_pktlog" },
#endif
};
                                 ...
                                 char *extra)
{
    ...
    struct ol_ath_softc_net80211 *scn =  ath_netdev_priv(dev);
    int *param = (int *) extra;
    int gpionum, input, pulltype, intrmode, mux_config_val, drive, init_enable;
    ...
    pulltype       = param[2];
    intrmode       = param[3];
    mux_config_val = param[4];
    drive          = param[5];
    /* Pass negated value to match with cfg80211tool implementation */
    init_enable    = !(param[6]);
    ...
    tgt_gpio_config(psoc, gpionum, input, pulltype, intrmode, mux_config_val, drive, init_enable);
                                 ...
                                 char *extra)
{
    ...
    tgt_gpio_output(psoc, gpionum, set);
 ...
 */
    ...
    (iw_handler) null_ioctl_func,
#if QCA_SUPPORT_SON
	(iw_handler) son_ioctl_ald_getStatistics,   /* SIOCWFIRSTPRIV+10 */
#else
	(iw_handler) null_ioctl_func,
#endif
#if UNIFIED_SMARTANTENNA
