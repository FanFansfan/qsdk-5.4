 ...
 * @pdev   : Reference to global vdev object
 * @value  : Value to enable STATS
 *
 * This API is used to enable ATF stats.
 *
 * Return  : 0 on Success
 *           -1 on Failure
 */
 ...
 * @pdev   : Reference to global pdev object
 *
 * This API is used to get ATF stats enabled or disabled.
 *
 * Return  : 0 if disabled
 *           1 if enabled
 */
...
/**
 * ucfg_atf_set_stats_timeout() - API to set ATF stats timeout period
 * @pdev   : Reference to global pdev object
 * @value  : Value to configure timeout period
 *
 * Return   : 0 on Success
 *            -1 on Failure
 */
...
/**
 * ucfg_atf_get_stats_timeout() - API to get ATF stats timeout period
 * @pdev   : Reference to global pdev object
 *
 * Return   : ATF stats timeout period
 */
int32_t ucfg_atf_get_stats_timeout(struct wlan_objmgr_pdev *pdev);

/**
 * ucfg_atf_get_stats() - API to get ATF stats
 * @vdev   : Reference to global vdev object
 * @tbl    : atftable refernce to hold ATF stats
 *
...
/**
 * ucfg_atf_get_ac_stats() - API to get ATF AC based stats
 * @vdev   : Reference to global vdev object
 * @buf    : atfgrouplist refernce to hold ATF AC stats
 *
 * Return   : 0 for sucess -1 for failure
 */
