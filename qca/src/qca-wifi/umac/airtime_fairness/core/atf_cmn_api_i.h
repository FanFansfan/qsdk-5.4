...
/**
 * atf_stats_start_timer() -  API to start ATF stats accumulation timer
 * @pdev : Reference to pdev global object
 *
 * Return : None
 */
...
/**
 * atf_stats_stop_timer() -  API to stop ATF stats accumulation timer
 * @pdev : Reference to pdev global object
 *
 * Return : None
 */
...
/**
 * atf_set_ppdu_stats() - API to subscribe PPDU stats
 * @pdev : Reference to pdev global object
 * @value: value 0 to unsuscribe 1 to enable subscribe
 *
...
/**
 * atf_stats_reset() - Internal function to reset ATF stats
 * @pdev : Reference to PDEV global object
 *
 * Return : none
 */
