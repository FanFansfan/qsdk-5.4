...
u_int8_t *
ieee80211_add_qbssload_ie(struct ieee80211vap *vap,
                          u_int8_t *frm,
...
#define ieee80211_add_qbssload_ie(vap, frm, ni)              (frm)
...
u_int8_t *
ieee80211_add_ext_bssload_ie(struct ieee80211vap *vap,
                             u_int8_t *frm,
                             struct ieee80211_node *ni);

u_int8_t *
ieee80211_ext_bssload_beacon_setup(struct ieee80211vap *vap,
                                   struct ieee80211_node *ni,
                                   struct ieee80211_beacon_offsets *bo,
                                   u_int8_t *frm);
...
#define ieee80211_add_ext_bssload_ie(vap, frm, ni)              (frm)
