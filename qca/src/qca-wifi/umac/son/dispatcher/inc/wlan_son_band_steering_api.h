/*
 * Copyright (c) 2014,2017,2021 Qualcomm Innovation Center, Inc.
 * All Rights Reserved
...
struct bs_probe_req_data {
    struct bs_probe_req_ind probe_req;
    u_int8_t is_chan_2G;
};
 ...
 */
struct bs_client_disconnect_ind {
    struct bs_disconnect_ind disconnect_event_data;
    struct bs_sta_stats_ind sta_stats_event_data;
};
