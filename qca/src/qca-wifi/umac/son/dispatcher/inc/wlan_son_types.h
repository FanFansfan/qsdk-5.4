...
typedef enum {
	...
	/* Get WIFI6 STA stats  for MAP */
	SON_DISPATCHER_CMD_MAP_WIFI6_STATS = 26,
	/* Set commands for ald */
	SON_DISPATCHER_CMD_SET_ALD = 27,
} SON_DISPATCHER_CMD;
...
enum son_event_type {
	SON_EVENT_NONE,
	SON_EVENT_ALD_ASSOC,
	SON_EVENT_ALD_BUFFULL,
	SON_EVENT_ALD_CBS,
	SON_EVENT_ALD_ACS_COMPLETE,
	SON_EVENT_ALD_CAC_COMPLETE,
	SON_EVENT_ALD_ASSOC_ALLOWANCE_STATUS,
	SON_EVENT_ALD_WNM_FRAME_RECVD,
	SON_EVENT_ALD_ANQP_FRAME_RECVD,
	SON_EVENT_BSTEERING_TX_AUTH_FAIL,
	SON_EVENT_BSTEERING_DBG_TX_AUTH_ALLOW,
	SON_EVENT_BSTEERING_TX_ASSOC_FAIL,
	SON_EVENT_BSTEERING_NODE_ASSOCIATED,
	SON_EVENT_BSTEERING_CLIENT_DISCONNECTED,
};
...
struct son_ald_assoc_allow_event_info {
...
struct son_beacon_frm_info {
	struct ieee80211_ie_whc_apinfo *se_sonadv;
	u_int8_t snr;
};
#endif
