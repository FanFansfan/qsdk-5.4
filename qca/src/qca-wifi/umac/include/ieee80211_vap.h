...
/**
 * ieee80211_vap_is_roaming() - function to check vap roaming state
 * @vap: ieee80211vap object
 *
 * API, function to check if STA vap connection sm is in roaming state
 *
 * Return: true if vap connection sm is in roaming state false otherwise
 */
bool ieee80211_vap_is_roaming(struct ieee80211vap *vap);
