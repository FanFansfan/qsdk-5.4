...
#define OCE_ATTRIB_TRANSMIT_POWER          0x6B  /* = 107 */
#define OCE_ATTRIB_IP_SUBNET_IND           0x6C  /* = 108 */
...
u_int8_t *ieee80211_add_ess_rpt_ie(u_int8_t *frm, struct ieee80211vap *vap);
...
static inline u_int8_t *ieee80211_add_ess_rpt_ie(u_int8_t *frm, struct ieee80211vap *vap)
{
    return 0;
}
