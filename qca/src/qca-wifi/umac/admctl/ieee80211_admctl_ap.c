...
int ieee80211_admctl_send_delts(struct ieee80211vap *vap, u_int8_t *macaddr, u_int8_t tid)
{
    ...
    ni = ieee80211_find_txnode(vap, macaddr, WLAN_MLME_SB_ID);
    if (ni == NULL) {
        error = -EINVAL;
        return error;
    }
...
static inline void
ieee80211_admctl_rt_setup(struct ieee80211com *ic, enum ieee80211_phymode mode, struct ieee80211_admctl_rt *rt )
{
...
{
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11A, (&ieee80211_admctl_rt_11a));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11G, (&ieee80211_admctl_rt_11g));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11B, (&ieee80211_admctl_rt_11b));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11NA_HT20, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11NA_HT40PLUS, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11NA_HT40MINUS, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11NG_HT20, (&ieee80211_admctl_rt_11ng));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11NG_HT40PLUS, (&ieee80211_admctl_rt_11ng));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11NG_HT40MINUS, (&ieee80211_admctl_rt_11ng));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXG_HE20, (&ieee80211_admctl_rt_11ng));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXG_HE40, (&ieee80211_admctl_rt_11ng));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXG_HE40PLUS, (&ieee80211_admctl_rt_11ng));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXG_HE40MINUS, (&ieee80211_admctl_rt_11ng));
    /* XXX: to be fixed when 11AC support is added; for now use 11na table  for VHT mode */
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AC_VHT20, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AC_VHT40PLUS, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AC_VHT40MINUS, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AC_VHT40, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AC_VHT80, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AC_VHT160, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AC_VHT80_80, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXA_HE20, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXA_HE40PLUS, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXA_HE40MINUS, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXA_HE40, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXA_HE80, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXA_HE160, (&ieee80211_admctl_rt_11na));
    ieee80211_admctl_rt_setup(ic, IEEE80211_MODE_11AXA_HE80_80, (&ieee80211_admctl_rt_11na));
    return 0;
}
