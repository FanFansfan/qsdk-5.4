...
struct ieee80211_node *wlan_objmgr_find_node_debug(struct ieee80211com *ic, uint8_t *macaddr,
                              wlan_objmgr_ref_dbgid id, const char *func, int line);

qdf_list_t *wlan_objmgr_populate_logically_deleted_node_list_debug
			(struct ieee80211com *ic, uint8_t *macaddr, uint8_t *bssid,
                                             wlan_objmgr_ref_dbgid id, const char *func, int line);
#else
struct ieee80211_node *wlan_objmgr_find_node(struct ieee80211com *ic, uint8_t *macaddr,
