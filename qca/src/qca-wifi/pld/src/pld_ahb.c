...
static const struct platform_device_id ath9k_platform_id_table[] = {
	...
	{
		.name = "qcn6122_wmac", /* Update the name with proper device name (ipqxxxx) */
...
int pld_ahb_register_driver(void)
{
	return qal_vbus_register_driver((struct qdf_pfm_drv *)&pld_ahb_ops);
}

void pld_ahb_unregister_driver(void)
{
	qal_vbus_register_driver((struct qdf_pfm_drv *)&pld_ahb_ops);
}
#else /* CONFIG_X86 */
int pld_ahb_register_driver(void)
{
