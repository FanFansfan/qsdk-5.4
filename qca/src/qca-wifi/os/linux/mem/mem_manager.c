...
qdf_export_symbol(mm_dbg_enable);
...
qdf_export_symbol(__wifi_kmem_allocation);
qdf_export_symbol(__wifi_kmem_free);
qdf_export_symbol(__wifi_cmem_allocation);
qdf_export_symbol(__wifi_cmem_free);
