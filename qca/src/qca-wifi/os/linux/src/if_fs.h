...
/**
 * DOC: if_fs.h
 * This file provides OS dependent and abstraction filesystem API's.
 */
#ifndef __QDF_FS_H__
#define __QDF_FS_H__
...
/**
 * qdf_fs_write - Write a segment of data from file system to memory buffer
 * @filename: the file name (with including file path) to be written
 * @offset: from position in file, unit is bytes
 * @size: bytes conter to be got
 * @buffer: a buffer pointer to save data to be read
 *
