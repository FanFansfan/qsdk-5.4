...
#define ATHCFG_WCMD_STAINFO_MCS_NULL      0xff
    ...
    uint8_t                     rx_snr;                      /* SNR of all received frames */
    uint8_t                     rx_snr_beacon;               /* SNR of Beacon */
 ...
 * @brief get rssi
 */
typedef struct athcfg_wcmd_snr{
    uint8_t      bc_avg_snr;      /* average snr */
    uint8_t      bc_valid_mask;   /* bitmap of valid elements in snr_ctrl/ext array */
    uint8_t      bc_snr_ctrl[ACFG_MAX_ANTENNA];
    uint8_t      bc_snr_ext[ACFG_MAX_ANTENNA];
    uint8_t      data_avg_snr;     /* average snr */
    uint8_t      data_valid_mask;   /* bitmap of valid elements in snr_ctrl/ext array */
    uint8_t      data_snr_ctrl[ACFG_MAX_ANTENNA];
    uint8_t      data_snr_ext[ACFG_MAX_ANTENNA];
}athcfg_wcmd_snr_t;
