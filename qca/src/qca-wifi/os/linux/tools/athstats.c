...
static void dp_pdev_printstats(FILE *fd, const struct cdp_pdev_stats *ath_stats)
{
    ...
    fprintf(fd, "\tfrag_alloc_fail                                      :\t%u\n",
            ath_stats->replenish.frag_alloc_fail);
    ...
    fprintf(fd, "\ttotal no of received igmp packets                    :\t%u\n",
            ath_stats->tx_i.igmp_mcast_en.igmp_rcvd);
    fprintf(fd, "\ttotal no of multicast igmp converted packets         :\t%u\n",
            ath_stats->tx_i.igmp_mcast_en.igmp_ucast_converted);
