...
int handle_command_deny_list    (int argc, char *argv[], const char *ifname, struct socket_context *sock_ctx);
...
int handle_command_peer_isolation(int argc, char *argv[], const char *ifname, struct socket_context *sock_ctx);
...
int handle_command_rtt     (int argc, char *argv[], const char *ifname, struct socket_context *sock_ctx);
