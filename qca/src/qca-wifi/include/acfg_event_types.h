...
typedef struct acfg_wsupp_dpp_conf_received {
    char raw_message[20];                      /**< always, undecoded char data */
} acfg_wsupp_dpp_conf_received_t;

typedef struct acfg_wsupp_dpp_confobj_akm {
    char raw_message[30];                      /**< always, undecoded char data */
} acfg_wsupp_dpp_confobj_akm_t;

typedef struct acfg_wsupp_dpp_confobj_ssid {
    char raw_message[128];                      /**< always, undecoded char data */
} acfg_wsupp_dpp_confobj_ssid_t;

typedef struct acfg_wsupp_dpp_confobj_pass {
    char raw_message[128];                      /**< always, undecoded char data */
} acfg_wsupp_dpp_confobj_pass_t;

typedef struct acfg_wsupp_dpp_confobj_connector {
    char raw_message[1000];                      /**< always, undecoded char data */
} acfg_wsupp_dpp_confobj_connector_t;

typedef struct acfg_wsupp_dpp_confobj_csign {
    char raw_message[1000];                      /**< always, undecoded char data */
} acfg_wsupp_dpp_confobj_csign_t;

typedef struct acfg_wsupp_dpp_confobj_netaccesskey {
    char raw_message[1000];                      /**< always, undecoded char data */
} acfg_wsupp_dpp_confobj_netaccesskey_t;
...
typedef struct acfg_wdt_event {
    acfg_reason_t           reason;
    uint8_t                 dump_file[FW_DUMP_FILE_NAME_SIZE];
} acfg_wdt_event_t;
