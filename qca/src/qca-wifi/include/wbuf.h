...
static INLINE void wbuf_set_incorrect_pmf_key(wbuf_t wbuf) {  __wbuf_set_incorrect_pmf_key(wbuf); }
static INLINE int wbuf_is_incorrect_pmf_key(wbuf_t wbuf) { return __wbuf_is_incorrect_pmf_key(wbuf); }
