...
typedef struct acfg_event {
    ...
    uint32_t  (*dpp_conf_received)(uint8_t *, acfg_wsupp_dpp_conf_received_t *);
    uint32_t  (*dpp_confobj_akm)(uint8_t *, acfg_wsupp_dpp_confobj_akm_t *);
    uint32_t  (*dpp_confobj_ssid)(uint8_t *, acfg_wsupp_dpp_confobj_ssid_t *);
    uint32_t  (*dpp_confobj_pass)(uint8_t *, acfg_wsupp_dpp_confobj_pass_t *);
    uint32_t  (*dpp_confobj_connector)(uint8_t *, acfg_wsupp_dpp_confobj_connector_t *);
    uint32_t  (*dpp_confobj_csign)(uint8_t *, acfg_wsupp_dpp_confobj_csign_t *);
    uint32_t  (*dpp_confobj_netaccesskey)(uint8_t *, acfg_wsupp_dpp_confobj_netaccesskey_t *);
} acfg_event_t;
