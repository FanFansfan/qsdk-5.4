...
void debug_print_samp_msg (struct spectral_samp_msg *samp)
{
...
{
    int i=0;
    struct spectral_samp_msg *msg_ptr;
...
void print_samp_msg (struct spectral_samp_msg *samp)
{
    struct spectral_samp_data *data = &(samp->samp_data);
    SPECTRAL_DPRINTF(ATH_DEBUG_SPECTRAL2,"struct spectral_samp_msg ");
