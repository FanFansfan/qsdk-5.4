...
typedef enum ieee1905Event_e
{
    ...
    IEEE1905_EVENT_DPP_ONBOARDING,
    IEEE1905_EVENT_DPP_BSS_CONFIG,
    IEEE1905_EVENT_EAPOL,
    IEEE1905_EVENT_DPP_BOOTSTRAPPING,
    IEEE1905_EVENT_FAILED_CONNECTION,
    IEEE1905_EVENT_SERVICE_PRIORTIZATION,
    IEEE1905_EVENT_ENCRYPTED_MESSAGE,
    IEEE1905_EVENT_INTEGRITY_MESSAGE,
    IEEE1905_EVENT_ENCRYPTION_CHECK,
    IEEE1905_EVENT_INTEGRITY_CHECK,
    IEEE1905_EVENT_AGENTS_LIST,
    IEEE1905_EVENT_Q_CAP,
...
/*
 * Callback format to check and enable security for IEEE1905.1 packets
 */
typedef void (*ieee1905SecurityCheckCallback_f)(ieee1905Event_e event, u_int8_t *frame,
                                                u_int32_t *len, const struct ether_addr *dest);
...
/*
 * ieee1905MessageBufferGetLarge - Get a pointer to the large message buffer
 */
...
/*
 * ieee1905DispatchMessage - Dispatch an ieee1905 message
 * @frame: Address of the frame
 * @len: Length of this frame should be sent
 * @type: Message Type
 */
...
/*
 * ieee1905InitStage2 - Module init stage2 function
 * @mapVersionEnabled: The map version
 * @ieee1905SecurityCheckCallback: Callback to call when a packet needs to be encrypted
 */
