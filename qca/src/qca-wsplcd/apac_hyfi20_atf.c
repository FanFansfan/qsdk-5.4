...
int apacHyfi20ConfigAtf_radioparams( char *iface, u_int32_t param, u_int32_t val) {
    ...
    if(setParam_cfg80211(wlanIfWd->ctx, iface, (param | ATH_PARAM_SHIFT), &val , sizeof(val)) < 0) {
...
int apacHyfi20ConfigAtf_addgroup( char *ifname, char *grpname, char *grpssid ) {
    ...
    if (getGenericInfoAtf_cfg80211(wlanIfWd->ctx, ifname, IEEE80211_IOCTL_ATF_ADDGROUP,  &set_group, sizeof(set_group)) < 0) {
...
int apacHyfi20ConfigAtf_delgroup(const char *ifname, char *grpname) {
    ...
    if (getGenericInfoAtf_cfg80211(wlanIfWd->ctx, ifname, IEEE80211_IOCTL_ATF_DELGROUP, &del_group, sizeof(del_group)) < 0) {
        dprintf(MSG_ERROR, "Unable to add ATF group\n");
        return -1;
    }
...
int apacHyfi20ConfigAtf_configgroup(const char *ifname, char *grpname, u_int32_t val) {
    ...
    if (getGenericInfoAtf_cfg80211(wlanIfWd->ctx, ifname, IEEE80211_IOCTL_ATF_CONFIGGROUP, &config_group, sizeof(config_group)) < 0) {
...
int apacHyfi20ConfigAtf_addssid(const char *ifname, char *ssid, u_int32_t val) {
    ...
    if (getGenericInfoAtf_cfg80211(wlanIfWd->ctx, ifname, IEEE80211_IOCTL_ATF_ADDSSID, &set_atp, sizeof(set_atp)) < 0) {
...
int apacHyfi20ConfigAtf_delssid(const char *ifname, char *ssid) {
    ...
    if (getGenericInfoAtf_cfg80211(wlanIfWd->ctx, ifname, IEEE80211_IOCTL_ATF_DELSSID, &set_atp, sizeof(set_atp)) < 0) {
...
int apacHyfi20ConfigAtf_addsta(const char *ifname, u8 *macaddr, u_int32_t val, const char *ssid) {
    ...
    if (getGenericInfoAtf_cfg80211(wlanIfWd->ctx, ifname, IEEE80211_IOCTL_ATF_ADDSTA, &set_sta, sizeof(set_sta)) < 0) {
...
int apacHyfi20ConfigAtf_delsta(const char *ifname, u8 *macaddr) {
    ...
    if (getGenericInfoAtf_cfg80211(wlanIfWd->ctx, ifname, IEEE80211_IOCTL_ATF_DELSTA, &set_sta, sizeof(set_sta)) < 0) {
...
int apacHyfi20atfGroupEnable( const char *iface, int val) {
    ...
    if(setParam_cfg80211(wlanIfWd->ctx, iface, IEEE80211_PARAM_ATF_SSID_GROUP, &val , sizeof(val)) < 0) {
        dprintf(MSG_ERROR, "%s: ioctl() failed, ifName: %s\n", __func__, iface);
        goto err;
    }
...
int apacHyfi20atfCommit( const char *iface, int val) {
    ...
    if(setParam_cfg80211(wlanIfWd->ctx, iface, IEEE80211_PARAM_ATF_OPT, &val , sizeof(val)) < 0) {
        dprintf(MSG_ERROR, "%s: ioctl() failed, ifName: %s\n", __func__, iface);
        goto err;
    }
