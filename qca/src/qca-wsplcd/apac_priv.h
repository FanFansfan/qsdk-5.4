...
/* Function to read NBTlv received from the search message */
int NBTlvReadReceiveSearch(apacHyfi20Data_t *ptrData, u8 *frame, u32 frameLen);

/* ioctl */
int apacHyfi20GetDeviceMode(apacHyfi20IF_t *pIF);
int apacMibGetRadioIdxByMacAddr(u8 *mac);
int apacMibGetRadioIdxByOpclass(int numOpClassRanges, int minOpClass, int maxOpClass);
