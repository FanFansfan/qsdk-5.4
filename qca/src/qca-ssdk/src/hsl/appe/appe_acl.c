...
appe_pre_ipo_dbg_addr_ipo_dbg_addr_get(
		...
		a_uint32_t *value)
{
	union pre_ipo_dbg_addr_u reg_val;
	sw_error_t ret = SW_OK;

	ret = appe_pre_ipo_dbg_addr_get(dev_id, &reg_val);
		...
		a_uint32_t value)
{
	...
	ret = appe_pre_ipo_dbg_addr_set(dev_id, &reg_val);
	return ret;
}
...
appe_pre_ipo_dbg_data_ipo_dbg_data_get(
		...
		a_uint32_t *value)
{
	union pre_ipo_dbg_data_u reg_val;
	sw_error_t ret = SW_OK;

	ret = appe_pre_ipo_dbg_data_get(dev_id, &reg_val);
...
appe_pre_ipo_spare_reg_spare_reg_get(
		...
		a_uint32_t *value)
{
	union pre_ipo_spare_reg_u reg_val;
	sw_error_t ret = SW_OK;

	ret = appe_pre_ipo_spare_reg_get(dev_id, &reg_val);
		...
		a_uint32_t value)
{
	...
	ret = appe_pre_ipo_spare_reg_set(dev_id, &reg_val);
	return ret;
}
...
appe_pre_ipo_glb_hit_counter_hit_count_get(
		...
		a_uint32_t *value)
{
	union pre_ipo_glb_hit_counter_u reg_val;
	sw_error_t ret = SW_OK;

	ret = appe_pre_ipo_glb_hit_counter_get(dev_id, &reg_val);
		...
		a_uint32_t value)
{
	...
	if (SW_OK != ret)
		return ret;
	reg_val.bf.hit_count = value;
	ret = appe_pre_ipo_glb_hit_counter_set(dev_id, &reg_val);
	return ret;
}
...
appe_pre_ipo_glb_miss_counter_miss_count_get(
		...
		a_uint32_t *value)
{
	union pre_ipo_glb_miss_counter_u reg_val;
	sw_error_t ret = SW_OK;

	ret = appe_pre_ipo_glb_miss_counter_get(dev_id, &reg_val);
		...
		a_uint32_t value)
{
	...
	if (SW_OK != ret)
		return ret;
	reg_val.bf.miss_count = value;
	ret = appe_pre_ipo_glb_miss_counter_set(dev_id, &reg_val);
	return ret;
}
...
appe_pre_ipo_glb_bypass_counter_bypass_count_get(
		...
		a_uint32_t *value)
{
	union pre_ipo_glb_bypass_counter_u reg_val;
	sw_error_t ret = SW_OK;

	ret = appe_pre_ipo_glb_bypass_counter_get(dev_id, &reg_val);
		...
		a_uint32_t value)
{
	...
	if (SW_OK != ret)
		return ret;
	reg_val.bf.bypass_count = value;
	ret = appe_pre_ipo_glb_bypass_counter_set(dev_id, &reg_val);
	return ret;
}
