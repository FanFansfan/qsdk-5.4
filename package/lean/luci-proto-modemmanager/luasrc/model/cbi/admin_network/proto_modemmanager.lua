...
auth = section:taboption("general", Value, "auth", translate("身份验证类型"))
...
iptype = section:taboption("general", Value, "iptype", translate("IP连接类型"))
...
metric = section:taboption("general", Value, "metric", translate("跃点数"))
